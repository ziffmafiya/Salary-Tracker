/**
 * Data export service.
 * Builds the JSON payload and triggers a file download.
 * No DOM manipulation beyond the programmatic anchor-click trick.
 */
 ...
 */
export function exportData(jobs, entries) {
    if (entries.length === 0) {
