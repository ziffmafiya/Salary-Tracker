...
/**
 * Validate salary entry form values.
 * @param {{ jobId: string, month: string, salary: number, hours: number }} data
...
/**
 * Validate job form values.
 * @param {{ name: string, baseRate: number, baseHours: number }} data
 * @returns {{ valid: boolean, errors: string[] }}
 */
